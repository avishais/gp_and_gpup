...
1. Agathe Girard PhD thesis: Approximate Methods for Propagation of Uncertainty with Gaussian Process Models
                          http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.66.1826&rep=rep1&type=pdf

2. Marc Peter Deisenroth PhD thesis: Efficient Reinforcement Learning using Gaussian Processes
                          https://www.doc.ic.ac.uk/~mpd37/publications/thesis_mpd_corrected.pdf

3. Candela, Girard, ...: Propagation of uncertainty in Bayesian kernel models - application to multiple-step ahead forecasting
